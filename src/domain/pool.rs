...
pub struct Pool {
    ...
    /// Optional hard cap on how many resources may be registered in this pool.
...
impl Pool {
    ...
    /// Sets an optional maximum resource capacity for the pool.
    pub fn with_max_capacity(mut self, max_capacity: Option<i32>) -> Self {
